...
final class ZioTestRunner(val args: Array[String], val remoteArgs: Array[String])
    extends Runner
    with PlatformReflection {
...
object ZioTestRunner {
  def apply(args: Array[String], remoteArgs: Array[String], testClassLoader: ClassLoader): ZioTestRunner =
